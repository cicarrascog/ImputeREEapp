...
Campbell (2023)](https://link.springer.com/article/10.1007/s00410-023-02025-9) and the
...
The coefficient of determination of each model give an idea of how well the model fits the data. However, it important to consider that for the Chondrite-Onuma model, which is base in a quadratic regression, R squared values will be always higher. 
...
each model (one model per zircon grain). The option button (top right corner) allows to modify some
